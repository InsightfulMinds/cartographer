...
looked-for: launchctl list (not loaded, verified 08-16); the disable note names the reload command.
hits: nothing at runtime — that is the danger. 528 items sit unconsumed in comms/dispatch/inbox,
